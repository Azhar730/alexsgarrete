        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            <button
              ...
              className={`flex items-center gap-2.5 px-6 py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 ${activeTab === "privacy"
            ...
            <button
              ...
              className={`flex items-center gap-2.5 px-6 py-3.5 rounded-xl font-semibold text-sm transition-all duration-300 ${activeTab === "agreement"
                  ? "bg-[#5B6BBF] text-white shadow-lg shadow-[#5B6BBF]/25 scale-105"
                  : "bg-white text-gray-600 hover:bg-gray-50 border border-gray-200"
                }`}
            >
