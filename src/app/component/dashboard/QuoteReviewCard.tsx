  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center py-10 px-4">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 w-full max-w-lg shadow-sm">
        <h2 className="text-xl font-bold text-slate-800 mb-1">Review Your Quote</h2>
        <p className="text-sm text-slate-400 mb-6">
          Review Buster&apos;s coverage and payment summary before you continue to the agreement and payment step.
        </p>
        ...
        <div className="flex items-center gap-3 pb-5 border-b border-slate-100 mb-5">
          ...
          />
          <div>
            <p className="font-bold text-slate-800">Bella</p>
            <p className="text-xs text-slate-400">Golden Retriever • 3 years old</p>
          </div>
        </div>

        {/* Payment summary */}
        <div className="mb-5">
          <h3 className="text-sm font-bold text-slate-700 mb-3">Payment Summary</h3>
        ...
        {/* Info note */}
        <div className="bg-blue-50 rounded-lg px-4 py-3 flex items-start gap-2 mb-5">
          <span className="text-blue-400 mt-0.5 flex-shrink-0">ℹ</span>
          <p className="text-xs text-blue-700">
            By accepting, you agree to pay the initial setup fee today. Your monthly premium of{" "}
            <strong>$45.00</strong> will start 14 days after activation.
          </p>
        </div>

        <Link href="/quote/agreement">
          <Button className="w-full bg-slate-700 hover:bg-slate-800 text-white font-semibold mb-3">
            Accept
          </Button>
        </Link>
        <Button
        ...
        <DialogContent className="max-w-sm rounded-2xl p-0 overflow-hidden">
          <div className="p-6">
            ...
            <p className="text-sm text-slate-500 text-center mb-5 leading-relaxed">
              If you decline this quote, <strong>Bella</strong> will lose this tailored coverage
              plan. You can always start over, but premium rates may change.
            </p>

            <p className="text-xs font-semibold text-slate-600 mb-3">
              Reason for declining (optional)
            </p>
            <RadioGroup value={declineReason} onValueChange={setDeclineReason} className="space-y-2 mb-4">
              {declineReasons.map(({ id, label }) => (
                ...
                >
                  <RadioGroupItem value={id} id={id} className="text-slate-600" />
      ...
      <Dialog open={showDeclinedSuccess} onOpenChange={setShowDeclinedSuccess}>
        <DialogContent className="max-w-sm rounded-2xl p-0 overflow-hidden">
          <div className="p-8 text-center">
            ...
            <h3 className="text-lg font-bold text-slate-800 mb-2">Quote declined</h3>
            <p className="text-sm text-slate-500 mb-6">
              We&apos;ve updated your preference. You can request a new quote at any time.
            </p>
            <Link href="/">
              <Button
