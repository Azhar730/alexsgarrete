  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        ...
        <p className="text-sm text-slate-500 mt-1">Billed monthly on the 1st</p>
      </div>
      <div className="bg-white rounded-xl border border-slate-200 p-6">
        <p className="text-sm text-slate-500 font-medium mb-1">Next Payment</p>
        <p className="text-3xl font-bold text-slate-800">Oct 1</p>
        <p className="text-sm text-slate-500 mt-1">Total due: $45.00</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white rounded-xl border border-slate-200 p-6 mb-6">
      ...
      <div className="flex items-center justify-between py-3 px-4 rounded-lg border border-slate-100 bg-slate-50">
        <div className="flex items-center gap-3">
          <span className="text-blue-600 font-bold text-base italic">stripe</span>
          <div>
            <p className="text-base font-semibold text-slate-700">Visa •••• 4832</p>
            <p className="text-sm text-slate-400">Expires 09/27</p>
          </div>
        </div>
        <Button
          variant="ghost"
      ...
      <Button
        variant="ghost"
        size="sm"
        className="mt-3 text-sm text-slate-500 hover:text-slate-700 gap-1.5"
      >
        <Plus size={13} />
        Add
      </Button>
        ...
        <table className="w-full text-base">
          <thead>
            <tr className="border-b border-slate-100">
              <th className="text-left text-sm font-medium text-slate-400 pb-2 pr-4">
                Date
              </th>
              <th className="text-left text-sm font-medium text-slate-400 pb-2 pr-4">
                Description
              </th>
              <th className="text-right text-sm font-medium text-slate-400 pb-2 pr-4">
                Amount
              </th>
              <th className="text-right text-sm font-medium text-slate-400 pb-2">
                Status
              </th>
            </tr>
          </thead>
            ...
            {billingRecords.map((record) => (
              <tr key={record.id}>
                ...
                <td className="py-3 text-right">
                  <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200 text-sm px-2.5 py-0.5">
                    Paid
                  </Badge>
                </td>
              </tr>
